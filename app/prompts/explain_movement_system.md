...
- The publication dates come from a search index and are sometimes wrong. Check each article's own text. If it describes results, announcements or price moves that happened after the move date, it is misdated and cannot explain this move: give it relevance 0 and do not rely on it.
